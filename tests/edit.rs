...
mod tests {
    ...
    fn setup_test_environment() {
        storage::set_tasks_file("test_edit_success.json");
        let _ = std::fs::remove_file("test_edit_success.json");
    ...
    fn test_edit_task_success() {
        ...
        let index_to_edit = 1;
        edit_task(&mut tasks, index_to_edit, new_text.clone());
    ...
    fn test_edit_task_invalid_index() {
        ...
        edit_task(&mut tasks, invalid_index, new_text.clone());
